...
class InventoryStatus(models.Model):
    inventory_status_name = models.CharField(_("Inventory Status Name"), max_length=100)
    inventory_borrower = models.CharField(_("Inventory Borrower Name"), max_length=100)
    inventory_borrow_amount = models.PositiveSmallIntegerField(_("Inventory Borrow Amount"),)
    inventory_borrow_date = models.DateTimeField(_("Inventory Borrow Date"), auto_now_add=True)
    inventory_borrow_purpose = models.CharField(_("Inventory Borrow Purpose"), max_length=100)
    inventory_borrow_notes = models.TextField(_("Inventory Borrow Notes"), max_length=200, blank=True, null=True)
    inventory_is_returned = models.BooleanField(_("Is Returned?"), default=False)
    inventory_return_date = models.DateTimeField(_("Inventory Return Date"), blank=True, null=True)
    ...
    def __str__(self):
        return f"{self.inventory_status_name} {self.inventory_borrower}"
