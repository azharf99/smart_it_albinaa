...
class Students(models.Model):
    ...
    student_phone = models.CharField(max_length=15, blank=True, null=True, verbose_name=_("Student's Phone"))
    student_status = models.CharField(max_length=20, blank=True, default="Aktif", verbose_name=_("Student's Status"))
